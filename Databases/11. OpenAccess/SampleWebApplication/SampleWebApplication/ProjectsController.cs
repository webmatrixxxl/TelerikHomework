...
{
    /// <summary>
    /// Web API Controller for Projects entity defined in SampleWebApplicationModel.EntitiesModel data model
    /// </summary>
    public partial class ProjectsController : OpenAccessBaseApiController<SampleWebApplicationModel.Project, SampleWebApplicationModel.EntitiesModel>
    {
        /// <summary>
        ...
        public virtual SampleWebApplicationModel.Project Get(Int32 id)
        {
            SampleWebApplicationModel.Project entity = repository.GetBy(s => s.ProjectID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, SampleWebApplicationModel.Project entity)
        {
                        if (entity == null ||
                id != entity.ProjectID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SampleWebApplicationModel.Project entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SampleWebApplicationModel.Project>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.ProjectID });
