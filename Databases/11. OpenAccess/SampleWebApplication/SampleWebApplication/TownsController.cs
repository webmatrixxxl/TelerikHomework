...
{
    /// <summary>
    /// Web API Controller for Towns entity defined in SampleWebApplicationModel.EntitiesModel data model
    /// </summary>
    public partial class TownsController : OpenAccessBaseApiController<SampleWebApplicationModel.Town, SampleWebApplicationModel.EntitiesModel>
    {
        /// <summary>
        ...
        {
            this.repository = new TownRepository();
        }
        ...
        public TownsController(IOpenAccessBaseRepository<SampleWebApplicationModel.Town , SampleWebApplicationModel.EntitiesModel> repository)
        {
        ...
        public virtual SampleWebApplicationModel.Town Get(Int32 id)
        {
            SampleWebApplicationModel.Town entity = repository.GetBy(s => s.TownID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, SampleWebApplicationModel.Town entity)
        {
                        if (entity == null ||
                id != entity.TownID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SampleWebApplicationModel.Town entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SampleWebApplicationModel.Town>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.TownID });
