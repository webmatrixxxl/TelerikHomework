...
{
    /// <summary>
    /// Web API Controller for Addresses entity defined in SampleWebApplicationModel.EntitiesModel data model
    /// </summary>
    public partial class AddressesController : OpenAccessBaseApiController<SampleWebApplicationModel.Address, SampleWebApplicationModel.EntitiesModel>
    {
        /// <summary>
        ...
        public virtual SampleWebApplicationModel.Address Get(Int32 id)
        {
            SampleWebApplicationModel.Address entity = repository.GetBy(s => s.AddressID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, SampleWebApplicationModel.Address entity)
        {
                        if (entity == null ||
                id != entity.AddressID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SampleWebApplicationModel.Address entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SampleWebApplicationModel.Address>(httpStatusCode, entityToEmbed);
