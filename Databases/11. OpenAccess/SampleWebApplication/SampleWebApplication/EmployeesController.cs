...
{
    /// <summary>
    /// Web API Controller for Employees entity defined in SampleWebApplicationModel.EntitiesModel data model
    /// </summary>
    public partial class EmployeesController : OpenAccessBaseApiController<SampleWebApplicationModel.Employee, SampleWebApplicationModel.EntitiesModel>
    {
        /// <summary>
        ...
        public EmployeesController(IOpenAccessBaseRepository<SampleWebApplicationModel.Employee , SampleWebApplicationModel.EntitiesModel> repository)
        {
        ...
        public virtual SampleWebApplicationModel.Employee Get(Int32 id)
        {
            SampleWebApplicationModel.Employee entity = repository.GetBy(s => s.EmployeeID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, SampleWebApplicationModel.Employee entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SampleWebApplicationModel.Employee entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SampleWebApplicationModel.Employee>(httpStatusCode, entityToEmbed);
