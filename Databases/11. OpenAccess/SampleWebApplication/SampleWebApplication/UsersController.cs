...
{
    /// <summary>
    /// Web API Controller for Users entity defined in SampleWebApplicationModel.EntitiesModel data model
    /// </summary>
    public partial class UsersController : OpenAccessBaseApiController<SampleWebApplicationModel.User, SampleWebApplicationModel.EntitiesModel>
    {
        /// <summary>
        ...
        public UsersController(IOpenAccessBaseRepository<SampleWebApplicationModel.User , SampleWebApplicationModel.EntitiesModel> repository)
        {
        ...
        public virtual SampleWebApplicationModel.User Get(Int32 id)
        {
            SampleWebApplicationModel.User entity = repository.GetBy(s => s.UserID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, SampleWebApplicationModel.User entity)
        {
                        if (entity == null ||
                id != entity.UserID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SampleWebApplicationModel.User entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SampleWebApplicationModel.User>(httpStatusCode, entityToEmbed);
