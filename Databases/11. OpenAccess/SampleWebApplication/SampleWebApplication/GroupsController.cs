...
{
    /// <summary>
    /// Web API Controller for Groups entity defined in SampleWebApplicationModel.EntitiesModel data model
    /// </summary>
    public partial class GroupsController : OpenAccessBaseApiController<SampleWebApplicationModel.Group, SampleWebApplicationModel.EntitiesModel>
    {
        /// <summary>
        ...
        public virtual SampleWebApplicationModel.Group Get(Int32 id)
        {
            SampleWebApplicationModel.Group entity = repository.GetBy(s => s.GroupID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, SampleWebApplicationModel.Group entity)
        {
                        if (entity == null ||
                id != entity.GroupID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SampleWebApplicationModel.Group entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SampleWebApplicationModel.Group>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.GroupID });
