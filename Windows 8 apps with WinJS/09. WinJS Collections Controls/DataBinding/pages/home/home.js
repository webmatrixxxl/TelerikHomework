    ...
    WinJS.UI.Pages.define("/pages/home/home.html", {
        ...
        ready: function (element, options) {
            ...
            for (var i = 0; i < dataList.length; i++) {
                ...
                computerTemplate.render(dataList.pop(), repeater);
            }

            var grdListView = document.getElementById("grdRepeater").winControl;
            grdListView.itemDataSource = dataList.dataSource;
            ...
            btnSave.onclick = function (e) {
                ...
                var computerTemplate = document.getElementById("computer-template-container").winControl;
                var grdListView = document.getElementById("computer-template-container").winControl;

                 dataList.push(Data.getComputer(txtName, txtPrice, txtImage, txtModelName, txtFrequencyGHz));
                grdListView.itemDataSource = dataList.dataSource;
