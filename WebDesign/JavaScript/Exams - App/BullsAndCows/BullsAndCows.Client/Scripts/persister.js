...
var persisters = (function () {
    ...
    var UserPersister = Class.create({
        ...
        scores: function (user, success, error) {
        }
    });
    ...
    var MassagesPersister = Class.create({
        init: function () {
        },
        unread: function () {
        },
...
//localhost:40643/api/user/create
//localhost:40643/api/user/join
//localhost:40643/api/massages/