...
function required_sample_credits() {
	_e( '<p>&copy; Telerik CMS Course | Design: <a href="http://academy.telerik.com/">Telerik Software Academy</a></p>' );
}
...
function required_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Second-Sidebar', 'requiredfoundation' ),
		'id' => 'sidebar-main-second',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
