namespace Telerik.ILS.Common
{
    ...
    {
        /// <summary>
        /// Generate Md5 Hash form string
        /// </summary>
        /// <param name="input">The string that will be computed to hash.</param>
        ...
        /// <summary>
        /// Try to converts string to <see cref="System.Int32"/>.
        /// </summary>
        /// <param name="input">The string to convert.</param>
        ...
        /// <summary>
        /// Try to converts string to <see cref="System.Int64"/>.
        /// </summary>
        /// <param name="input">The string to convert.</param>
        /// <returns>The string value as <see cref="System.Int32"/> or 0 if TryParse == false.</returns>
        ...
        /// <summary>
        /// Try to converts string to <see cref="System.DateTime"/>.
        /// </summary>
        /// <param name="input">The string to convert.</param>
        ...
        /// <summary>
        /// Converts string from Cyrillic to Latin following the phonetic keyboard layout.
        /// </summary>
        /// <param name="input">The string to convert.</param>
        ...
        /// <summary>
        /// Converts string from Latin to Cyrillic following the phonetic keyboard layout.
        /// </summary>
        /// <param name="input">The string to convert.</param>
        ...
        /// <summary>
        /// Converts a string from Cyrillic letters which there's Latin equivalents
        /// and all non-alphanumeric characters (excluding the period ".") are removed.
        /// </summary>
        /// <param name="input">The input string to proccess.</param>
        /// <returns>String that is preccessed.</returns>
        ...
        /// <summary>
        /// Converts a string from Cyrillic letters which there's Latin equivalents
        /// spaces are replaced with hyphens and all non-alphanumeric characters (excluding the period ".") are removed.
        /// </summary>
        /// <param name="input">The input string to proccess.</param>
        /// <returns>String that is preccessed.</returns>
        ...
        /// <summary>
        /// Returns substring form the begining and whose length is the lesser of the string's length and <paramref name="charsCount"/>.
        /// </summary>
        /// <param name="input">This instance.</param>
        /// <param name="charsCount">The number of characters.</param>
        /// <returns>Substring from start to <param name="charsCount">-1 characters.</returns>
        ...
        /// <returns>String with extension of file name.</returns>
