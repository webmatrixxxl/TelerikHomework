...
namespace _03.WordOccurance
{
    class WordOccurance
    {
        static void Main(string[] args)
        {
            ...
            AddWordsForSearchInDictionary(stopwatch, wordsToSearch, wordsInDictionary);
            AddWordsForSearchInTrie(stopwatch, start, wordsToSearch);

            IncrementOccuranceCountTrie(stopwatch, start, allWords);
            IncrementOccuranceCountDictionary(stopwatch, wordsInDictionary, allWords);
